Locales['fr'] = {
  ...
  -- Main Menu
  ['mainmenu_subtitle'] = 'CrewLife RP',
  ['mainmenu_gps_button'] = '📍 Mon GPS',
...
['clothes_title'] = '👚 Vetements',
  ...
  ['loadout_drop_button'] = 'Jeter',
	...
	['accessories_no_ears'] = 'Vous ne possedez pas d\'Accessoire d\'Oreilles',

	['accessories_no_glasses'] = 'Vous ne possedez pas de Lunettes',

	['accessories_no_helmet'] = 'Vous ne possedez pas de Casque/Chapeau',

	['accessories_no_mask'] = 'Vous ne possedez pas de Masque',
...
['animation_title'] = '💃 Animations',
	...
	['animation_party_dancing'] = 'Faire la F�te',
	...
	['animation_party_drunk'] = 'Bourr� sur place',

	['animation_party_vomit'] = 'Vomir en voiture',

	

	['animation_action_title'] = 'Actions',

	['animation_action_saluate'] = 'Recule Arm�',

	['animation_action_serrer'] = 'On Bouge Pas !  ',

	['animation_action_tchek'] = 'Au Sol !  ',

    ['animation_action_bandit'] = 'Allez On Suit !  ',

	['animation_action_military'] = 'Western',

	['animation_action_suspect'] = 'Gangster',
	...
	['animation_work_fisherman'] = 'P�cheur',

	['animation_work_inspect'] = 'Police : enqu�ter',

	['animation_work_radio'] = 'Police : parler � la radio',

	['animation_work_circulation'] = 'Police : circulation',

	['animation_work_binoculars'] = 'Police : jumelles',

	['animation_work_harvest'] = 'Agriculture : r�colter',

	['animation_work_repair'] = 'D�panneur : r�parer le moteur',

	['animation_work_observe'] = 'M�decin : observer',
	...
	['animation_mood_felicitate'] = 'F�liciter',
	...
	['animation_mood_tired'] = 'Etre �puis�',
	...
	['animation_mood_suicide'] = 'Balle dans la t�te',
	...
	['animation_other_beer'] = 'Bi�re en Zik',

	['animation_other_sit'] = 'S\'asseoir',

	['animation_other_waitwall'] = 'Attendre contre un mur',

	['animation_other_ontheback'] = 'Couch� sur le dos',

	['animation_other_stomach'] = 'Couch� sur le ventre',

	['animation_other_clean'] = 'Nettoyer',

	['animation_other_cooking'] = 'Pr�parer � manger',

	['animation_other_search'] = 'Position de Fouille',

	['animation_other_selfie'] = 'Prendre un selfie',

	['animation_other_door'] = 'Ecouter � une porte',
  ...
  ['wallet_show_driver_button'] = 'Montrer son ~b~-> permis de conduire',
  ['wallet_check_driver_button'] = 'Regarder son ~b~-> permis de conduire',
  ['wallet_show_firearms_button'] = 'Montrer son ~b~-> permis port d\'armes',
  ['wallet_check_firearms_button'] = 'Regarder son ~b~-> permis port d\'armes',
  ...
  ['vehicle_engine_button'] = 'Moteur : Allumer / Eteindre',
  ['vehicle_door_button'] = 'Porte : Ouvrir / Fermer',
  ['vehicle_hood_button'] = 'Capot : Ouvrir /  Fermer',
  ['vehicle_trunk_button'] = 'Coffre : Ouvrir / Fermer',
